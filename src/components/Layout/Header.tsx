    ...
    return (
        <header className="bg-site">
                ...
                <div className="flex lg:flex-1">
                    <a href="#" className="-m-1.5 p-1.5">
                        ...
                        <img
                            ...
                            src={Util.getEmojiHref("💸")}
                            alt=""
                        />
                    </a>
                    <p className="font-bold text-lg font-mono mx-1">gib</p>
                </div>
            ...
            >
                ...
                <Dialog.Panel className="fixed inset-y-0 right-0 z-10 flex w-full flex-col justify-between overflow-y-auto bg-objectBg sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                    <div className="p-6">
                    ...
                    <div className="absolute bottom-3 right-3  bg-object text-center">
                        {/* {callsToAction.map((item) => (
                            <a
                                key={item.name}
                                href={item.href}
